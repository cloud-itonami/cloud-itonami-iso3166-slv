(ns marketentry.phase
  "Phase 0->3 staged rollout for the Republic of El Salvador (SLV)
  ...
  real DINAC/COMPRASAL filing package and submitting a real filing /
  Registro de Comercio inscription request are the two real-world acts
